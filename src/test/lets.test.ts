...
test('let_as_as_bad_with_subtyping', () => {
    const res = parseAndTypecheck(`
language core;

extend with  #let-patterns, #pattern-ascriptions, #let-bindings, #structural-subtyping;
...
`);
    expectTypeError(res, error_type.ERROR_AMBIGUOUS_PATTERN_TYPE)
})
