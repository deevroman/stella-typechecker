...
import { LanguageDeclContext } from "./stellaParser";
import { ExtensionContext } from "./stellaParser";
import { DeclContext } from "./stellaParser";
import { AnnotationContext } from "./stellaParser";
import { ParamDeclContext } from "./stellaParser";
import { ExprContext } from "./stellaParser";
...
import { PatternContext } from "./stellaParser";
import { LabelledPatternContext } from "./stellaParser";
import { StellatypeContext } from "./stellaParser";
 ...
 */
export interface stellaParserVisitor<Result> extends ParseTreeVisitor<Result> {
	/**
	...
	/**
	 * Visit a parse tree produced by `stellaParser.languageDecl`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitLanguageDecl?: (ctx: LanguageDeclContext) => Result;

	/**
	 * Visit a parse tree produced by `stellaParser.extension`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `stellaParser.decl`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `stellaParser.annotation`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `stellaParser.expr`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `stellaParser.pattern`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `stellaParser.stellatype`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitStellatype?: (ctx: StellatypeContext) => Result;
